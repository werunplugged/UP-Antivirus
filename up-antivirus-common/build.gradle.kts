...
dependencies {
    ...
    "developmentApi"("com.unplugged:account-helper-development:1.0.9")
    "stagingApi"("com.unplugged:account-helper-staging:1.0.9")
    "productionApi"("com.unplugged:account-helper-production:1.0.9")
