...
dependencies {
    ...
    "developmentApi"("com.unplugged:account-helper-development:1.1.6")
    "stagingApi"("com.unplugged:account-helper-staging:1.1.6")
    "productionApi"("com.unplugged:account-helper-production:1.1.6")
