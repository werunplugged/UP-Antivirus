...
dependencies {
    ...
    "developmentApi"("com.unplugged:account-helper-development:1.0.8")
    "stagingApi"("com.unplugged:account-helper-staging:1.0.8")
    "productionApi"("com.unplugged:account-helper-production:1.0.8")
